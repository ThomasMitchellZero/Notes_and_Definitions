...
var budgetController = (function(){
    ...
    var x = 23
    // same thing here.  A named function is created for this execution context.  If this were a property and not a variable, anyone could accidentlly re-assign it from the global context by writing budgetController.add = 'someBullshit'  As a variable, it is safely out of global scope. 
    var add = function(a){
        return x + a;
    }
